...
# Parámetros
# ========================================
file_in = "C:/Users/Teresa/Desktop/COMPU/Grupo_Compu/programa_Ising/programaTeresa/spins_all_temps.txt" # Nombre del fichero de datos
...
for frame_data_str in data_str.split("\n\n"):
    ...
    frame_data = np.loadtxt(io.StringIO(frame_data_str))
