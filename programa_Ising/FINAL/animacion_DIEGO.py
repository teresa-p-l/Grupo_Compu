...
# Cargar spins
with open('C:/Users/diego/Desktop/Fisica_Computacional/Grupo_Compu/programa_Ising/FINAL/spins_all_temps.txt', 'r') as f:
    lines = f.readlines()
...
data = np.loadtxt('C:/Users/diego/Desktop/Fisica_Computacional/Grupo_Compu/programa_Ising/FINAL/ising_data.txt', skiprows=1)
...
with open('C:/Users/diego/Desktop/Fisica_Computacional/Grupo_Compu/programa_Ising/FINAL/datos_red.txt', 'r') as f:
    T, step, medidas = map(float, f.readline().strip().split())

ax_blank.axis('off')
ax_blank.text(0.5, 0.5,f'T = {T}, Step = {step}, Medidas = {medidas} \n No thread optimization \n intel i5 12450H, 8 cores', fontsize=12, ha='center', va='center', transform=ax_blank.transAxes)
...
plt.tight_layout()
plt.show()
ani.save(f'C:/Users/diego/Desktop/Fisica_Computacional/Grupo_Compu/programa_Ising/FINAL/animaciones/D animacion T = {T}, Step = {step}, Medidas = {medidas}, Spins = {N}, intel core i5 12450H, rtx 3050.mp4', writer='ffmpeg', fps=30)