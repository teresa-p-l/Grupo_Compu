...
# Cargar spins
with open('C:/Users/User/Documents/Fisica_compu/Compu/Grupo_Compu/Grupo_Compu/programa_Ising/FINAL/spins_all_temps.txt', 'r') as f:
    lines = f.readlines()
...
data = np.loadtxt('C:/Users/User/Documents/Fisica_compu/Compu/Grupo_Compu/Grupo_Compu/programa_Ising/FINAL/ising_data.txt', skiprows=1)
...
with open('C:/Users/User/Documents/Fisica_compu/Compu/Grupo_Compu/Grupo_Compu/programa_Ising/FINAL/datos_red.txt', 'r') as f:
    T, step, medidas = map(float, f.readline().strip().split())

ax_blank.axis('off')
ax_blank.text(0.5, 0.5,f'T = {T}, Step = {step}, Medidas = {medidas} \n No thread optimization \n intel core i-5 6300U, 2 cores', fontsize=12, ha='center', va='center', transform=ax_blank.transAxes)
...
plt.tight_layout()
plt.show()
ani.save(f'C:/Users/User/Documents/Fisica_compu/Compu/Grupo_Compu/Grupo_Compu/programa_Ising/FINAL/animaciones/animaciona T = {T}, Step = {step}, Medidas = {medidas}, Spins = {N}.mp4', writer='ffmpeg', fps=30)